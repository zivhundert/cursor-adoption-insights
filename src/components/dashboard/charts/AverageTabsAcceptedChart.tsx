    ...
    <Card>
      <CardHeader>
        <div className="flex items-center gap-2">
          <CardTitle className="text-xl font-semibold">Code Completions Trends ({getPeriodText()})</CardTitle>
          <TooltipProvider>
            <UITooltip>
              <TooltipTrigger>
              ...
              <TooltipContent>
                <p>Shows Tabs Accepted trends over time with total usage and per-user averages.</p>
